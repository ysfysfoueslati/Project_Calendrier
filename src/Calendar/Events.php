...
class Events{
    ...
    /**
     * creation d'un evenement au niveau de base de donnee
     * @param Event $event
     * @return bool
     */
    public function create(\Calendar\Event $event):bool{
    ...
    /**
     * met a jour un evenement au niveau de base de donnee
     * @param Event $event
     * @return bool
     */
    public function update(\Calendar\Event $event):bool{
